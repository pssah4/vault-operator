...
| ID | Type | Title | Status | Phase | Refs | Source | Commit | Claim | Last change | Notes |
|---|---|---|---|---|---|---|---|---|---|---|
| FEAT-29-01 | Feature | Folder-Konsolidierung (Option 1: alles vault-local plus Backup-Tool) | Done | Building | EPIC-29, PLAN-27, ADR-119, ADR-72, FEAT-29-12 | USER |  | sebastian-claude-opus-4-7 | 2026-05-20 | P0 Welle 1. Implementation abgeschlossen 2026-05-20. Alle 11 PLAN-27-Tasks gruen, Live-Test auf 288 MB knowledge.db erfolgreich, 51 Tests + Build green. Alles Plugin-State vault-local in .vault-operator/data/ und cache/. Vier Quell-Pfade konsolidiert. chatHistoryFolder-Removal, Drift-Resolve fuer skills/, drei Settings-Reset-Buttons + Restore-from-Backup-Service als Sicherheitsnetz, ChatHistoryFolderRemovedModal one-shot. Wartet auf /testing + /security-audit. Spec: `_devprocess/requirements/features/FEAT-29-01-folder-consolidation.md` |
| FEAT-29-02 | Feature | Plugin-Skill-Format-Migration (File zu Folder/SKILL.md) | Done | Building | EPIC-29, FEAT-29-01, PLAN-28 | USER |  | sebastian-claude-opus-4-7 | 2026-05-20 | P0 Welle 2. /coding abgeschlossen 2026-05-20. Alle 7 PLAN-28-Tasks gruen: VaultDNAScanner schreibt jetzt Anthropic-Folder-Layout, Frontmatter strikt nur name+description, Top-5 references/commands.md eager-generate, Cleanup alter data/plugin-skills/. Welle-1-abhaengig. 1784 Tests gruen. Wartet auf /testing + /security-audit + Live-Test. Spec: `_devprocess/requirements/features/FEAT-29-02-plugin-skill-format-migration.md` |
| FEAT-29-03 | Feature | Unified Discovery und probe_plugin-Tool | Done | Building | EPIC-29, FEAT-29-02, PLAN-29 | USER |  | sebastian-claude-opus-4-7 | 2026-05-20 | P0 Welle 3. Polling 30s->2s, workspace.layout-change-Hook (200ms debounce), Reclassify-Passes 1s+10s. Neuer probe_plugin Tool fuer Live-Commands+API. SkillRegistry-Prompt-Hint ergaenzt. Wartet auf /testing + /security-audit. Spec: `_devprocess/requirements/features/FEAT-29-03-unified-discovery-and-probe-plugin.md` |
| FEAT-29-04 | Feature | Execution Visibility (Notice-Capture) | Done | Building | EPIC-29, PLAN-29 | USER |  | sebastian-claude-opus-4-7 | 2026-05-20 | P0 Welle 3. NoticeCapture-Utility monkey-patcht window.Notice waehrend executeCommandById, 250ms async-Tail, Severity-Heuristik, sensitive-Filter, Truncation. ExecuteCommandTool tool_result strukturiert mit notices-Array. Wartet auf /testing + /security-audit. Spec: `_devprocess/requirements/features/FEAT-29-04-execution-visibility.md` |
...
| FEAT-29-06 | Feature | Sandbox-JS als First-Class-Skill-Pattern | Done | Building | EPIC-29, PLAN-30 | USER |  | sebastian-claude-opus-4-7 | 2026-05-20 | P1 Welle 4. /coding done. run_skill_script-Tool + RunSkillScriptCache (LRU+FNV-1a-Hash) + Bundler-Skip-on-Hit. ManageSkillTool ohne code_modules-Input. CodeModuleCompiler @deprecated. builtinModes-Mode-Body auf helper-scripts umgestellt. 1863/1884 Tests gruen (+25 Welle-4 erste Welle). Wartet auf /testing + /security-audit. Spec: `_devprocess/requirements/features/FEAT-29-06-sandbox-js-first-class.md` |
| FEAT-29-11 | Feature | Skill-Layout-Konsolidierung + Edit-Folder + Builtin-Materialisierung + Readme-Drop + Export-ZIP | Done | Building | EPIC-29, PLAN-31 | USER |  | sebastian-claude-opus-4-7 | 2026-05-21 | Welle 4 zweites Feature. /coding done, Live-Test bestaetigt 2026-05-21. Alle Steps durch: (0) data/skills/plugin/ Subfolder weg, einheitlich data/skills/{name}/ mit source-Frontmatter, (A) Edit-Button oeffnet Folder via electron.shell.openPath, (B) Built-ins materialisiert (BuiltinSkillMaterializer + esbuild recursive scan), (C) Plugin-Readmes weg, Body-Inhalt konsolidiert + references/-Cleanup pro Plugin-Write, (D) Export-ZIP via jszip + readBinary. Plus Live-Fixes: User-Skills-Filter in beiden Loops (SkillsManager liest selben data/skills/ via GlobalFileService root), Auto-Rescan im SkillsTab wenn scanner.hasScanned===false, Customize-Tab-Icon toolbox via addIcon-Polyfill. 1888/1909 Tests gruen (10 neue BuiltinSkillMaterializer-Tests, 21 baseline pre-existing). Wartet auf /testing + /security-audit. |
