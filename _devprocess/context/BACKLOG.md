...
| IMP-24-09-01 | Improvement | 09-01: Dead Code entfernen -- `SkillsManager.getRelevantSkills` wird nach FEAT-24-09 (Klassifikator-Entfernung) aus src/ nicht mehr aufgerufen; bei versehentlicher Re-Aktivierung waere die ADR-62/116-Cache-Stabilitaet wieder kompromittiert | Ready | Planned | FEAT-24-09, EPIC-24, AUDIT-019 | SEC |  |  | 2026-05-13 | P3 Info-Finding aus AUDIT-019 F-1; kein direkter Sicherheitsimpact, Code-Hygiene + Drift-Schutz. Verbleibende Caller pruefen, Methode + `xmlEscape` (falls nur dort genutzt) entfernen, BACKLOG-Row schliessen. |
| IMP-24-06-01 | Improvement | 06-01: TOOL_METADATA-Drift schliessen -- 16 Tools in der `ToolName`-Union haben keinen `TOOL_METADATA`-Eintrag (z.B. configure_model, switch_mode, recall_memory, search_history, ingest_deep/triage, _memory_*, mark_*_for_memory, read_agent_logs); 1 Tool in `TOOL_METADATA` ohne Union-Eintrag (check_presentation_quality). Bedeutung: ihre Schemas gehen ueber die Registry ins `tools`-Feld, aber sie fehlen in der zentralen System-Prompt-Tools-Listung und sind via find_tool nicht rankbar. | Ready | Planned | FEAT-24-06, EPIC-24, AUDIT-020 | SEC |  |  | 2026-05-13 | P3 Info-Finding aus AUDIT-020 F-1; kein direkter Sicherheitsimpact, Drift-Pattern. Pro Tool entscheiden: TOOL_METADATA-Eintrag schreiben oder begruendet weglassen; check_presentation_quality-Spiegelfall pruefen. Optional: TypeScript-Type/Vitest-Assertion fuer ToolName-Union vs TOOL_METADATA Konsistenz, damit das Pattern nicht wiederkehrt. |
