...
Last update: 2026-05-21 by coding (FEAT-29-05 Skill-Creator-Builtin done. Bundle skill-creator builtin (SKILL.md + 2 JS scripts + 2 references) under bundled-skills/, materialized to data/skills/skill-creator/ on plugin onload. manage_skill-Tool entfernt komplett (Wiring + ToolName-Union + toolMetadata + AgentSidebarView + System-Prompts + builtinModes). SkillFrontmatterValidator als hard-gate beim Discovery, 16 Tests. TaskRouter eskaliert "build me a skill"-Phrasen auf Flagship/Main-Model. Sandbox-Bridge erweitert: ctx.vault.mkdir + hidden-path support fuer .vault-operator/, EditFileTool adapter-fallback. Validator-Allowlist erweitert (version, keywords, author, when-to-use, argument-hint, context). VaultDNAScanner kebab-case fuer plugin-id im name-Frontmatter (note_uid_generator nicht mehr rejected). UI-polish: user-message-bubble color-mix 20%, customize-tab toolbox-icon. Reranker ONNX-Backend-Fix via globalThis-Symbol.for(onnxruntime) prepop (umgeht IS_NODE_ENV-Trap). Live-Test bestaetigt: weekly-meeting-summary live-erstellt + valide. Konsole-Warnings auf debug heruntergestuft (Ollama ECONNREFUSED, corrupted XLSX). 1918/1939 Tests gruen, kein new regression. Naechster Schritt: /testing + /security-audit fuer FEAT-29-05. Offen in EPIC-29 nach 29-05: FEAT-29-07/08/09/10/12. Wiedervorlage: Reranker-Install-Asset (2.11.7-assets release fehlt).)
...
| Active | 30 | Building | 74 | Feature | 225 |
...
| FIX-01-05-01 | Fix | edit_file laesst Agent grosse Rewrites mehrfach retryen statt write_file zu nutzen | Active | Building | FEAT-01-05, EPIC-01 | BUG |  | sebastian-claude-opus-4-7 | 2026-05-21 | P2 Live-Test 2026-05-21 zeigte 5+ edit_file-Retries mit `old_str not found` bei new_str=2397 chars im meeting-summary-Subskill. sizeHint-Schwelle steht auf 2000 chars und Wording war zu weich. Fix: Schwelle auf 1000 chars, Wording von "prefer" auf "Use write_file instead", optional longest-common-prefix-Hinweis. Spec: `_devprocess/requirements/fixes/FIX-01-05-01-edit-file-large-rewrite-steering.md` |
...
| FEAT-29-07 | Feature | Permission und Latency Polish | Active | Building | EPIC-29, FEAT-29-03, PLAN-36 | USER |  | sebastian-claude-opus-4-7 | 2026-05-21 | P2 Welle 4. /coding gestartet 2026-05-21. Adaptive Timeouts pro Plugin + Auto-Promotion (3 Approvals -> safeMethodOverrides) + isWrite-Heuristik (get/list/find/query). Spec: `_devprocess/requirements/features/FEAT-29-07-permission-and-latency-polish.md` |
| FEAT-29-08 | Feature | Skill-Translator-Builtin-Skill | Active | Building | EPIC-29, FEAT-29-02, FEAT-29-05, FEAT-29-06, ADR-127, PLAN-34 | USER |  | sebastian-claude-opus-4-7 | 2026-05-21 | P1 Welle 4. /coding gestartet 2026-05-21. Voller Scope: skill-translator-Builtin mit Dry-Run + Mapping + Translation + PartialTranslationModal + TaskRouter-Flagship-Routing. Spec: `_devprocess/requirements/features/FEAT-29-08-skill-translator-builtin.md` |
...
| FEAT-29-10 | Feature | Composability (Skill-zu-Skill und Skill-zu-MCP) | Active | Tested | EPIC-29, FEAT-29-03, FEAT-29-06, ADR-129, PLAN-33 | USER |  | sebastian-claude-opus-4-7 | 2026-05-21 | P1 Welle 4. /coding 2026-05-21 (47e35fee), /testing 2026-05-21. Voller Scope: invoke_skill + invoke_mcp_server Tools mit Context-Frame-Isolation via spawnSubtask, CompositionStackService fuer Cycle-Detection + Max-Depth. Spec: `_devprocess/requirements/features/FEAT-29-10-composability-skill-to-skill-and-mcp.md`. /testing: 14 neue Tests (9 CompositionStackService mit SC-01/SC-02/SC-04-describes + 5 InvokeMcpServerTool mit SC-03-describe). SC-03-Code-Fix in InvokeMcpServerTool.ts: `activeMcpServers`-Whitelist (Approval-Bypass-Loch geschlossen). 2034/2054 gruen, 20 pre-existing dev-baseline-failures (NICHT FEAT-29-10). Coverage-Tooling fehlt (`@vitest/coverage-v8`). Open: `/security-audit`. Handoff: `_devprocess/context/HANDOFFS.md` 2026-05-21-Eintrag. |
| FEAT-29-12 | Feature | Backup- und Export-Tool fuer Plugin-State (selektiv, ZIP, Auto-Daily) | Active | Building | EPIC-29, FEAT-29-01, PLAN-35 | USER |  | sebastian-claude-opus-4-7 | 2026-05-21 | P1 Welle 4. /coding gestartet 2026-05-21. Selektives ZIP-Backup mit Skills/Memory/History/Rules/Workflows-Auswahl + Konflikt-Modal + optional Auto-Daily. Spec: `_devprocess/requirements/features/FEAT-29-12-backup-export-tool.md` |
| FEAT-29-15 | Feature | /ingest und /ingest-deep Sense-Making-Notes mit Backlinks | Active | Building | EPIC-29, FEAT-29-14 | USER |  | sebastian-claude-opus-4-7 | 2026-05-21 | P2 Welle 4. /coding 2026-05-21: ingest + ingest-deep SKILL.md updates. Inline-Default `Kategorie:` jetzt YAML-Listen-Element (`- Quelle`/`- Source` statt `[Quelle]`) damit der Auto-Trigger (FEAT-19-27) matcht. Skill-Body bevorzugt explizit `vaultIngest.templates.*`-User-Template ueber Inline-Default. Neuer Step 4 in /ingest: User-Frage "Sense-Making-Note (A) / Multi-Zettel (B) / Nichts (C, Default)"; bei A/B Output-Note via `quellenNotizTemplate` (aus FEAT-29-14) mit Kategorie `- Quellen-Notiz`/`- Source note` und `Quellen: [[<basename>]]` Backref. Neuer Step 5 (Pflicht): nach Output-Notes `read_file` der Quelle + `update_frontmatter` mit `Notizen: [[note1]], ...` (append). Beide Skills um `update_frontmatter` in requiredTools erweitert, ingest-deep zusaetzlich `write_file`. 16/16 SkillFrontmatterValidator-Tests gruen. Depends-on FEAT-29-14. Spec: `_devprocess/requirements/features/FEAT-29-15-ingest-sense-making-and-backlinks.md` |
