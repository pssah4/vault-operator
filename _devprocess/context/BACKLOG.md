...
| FEAT-29-09 | Feature | Skill-Versionierung mit Snapshot und Restore | Active | Building | EPIC-29, FEAT-29-02, FEAT-29-05, PLAN-32 | USER |  | sebastian-claude-opus-4-7 | 2026-05-21 | P1 Welle 4. /coding gestartet 2026-05-21. Architektur: volle Datei-Kopien in skill-folder/.versions/{ts}/ (nicht diff-chain), Vault-Adapter Pre-Hook als universeller Snapshot-Trigger, Retention 20 + Tag-Schutz. Spec: `_devprocess/requirements/features/FEAT-29-09-skill-versioning.md` |
...
| PLAN-32 | Plan | FEAT-29-09 Skill-Versionierung (5 Tasks, TDD-strict) | Active | Building | FEAT-29-09, EPIC-29 | CODE | sebastian-claude-opus-4-7 |  | 2026-05-21 | Welle 4 drittes Feature. Volle Datei-Kopien in skill-folder/.versions/{ts}/. Vault-Adapter Pre-Hook als Trigger. Retention 20 + Tag-Schutz. 5 Tasks: A SnapshotService, B AdapterInterceptor, C VersionsModal UI, D Retention-Config, E V-Model close. |
