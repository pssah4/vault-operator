...
| FIX-01-04-01 | Fix | 04-01: Agent waehlt read_file + write_file statt edit_file und erzeugt Duplikate in der Note | Open | Candidates | FEAT-01-04, EPIC-01, FIX-01-07-03 | BUG | | | 2026-05-23 | P2 Live-Repro 2026-05-23 Madrid-Reise-Note. Tool-Choice-Bug auf LLM-Seite. Mehrere Hypothesen: (1) schwache Tool-Description-Steuerung wie bei FIX-01-05-01, (2) TaskRouter routet zu klein (Haiku), (3) FOLGEFEHLER von FIX-01-07-03 (Editor-Cache-Overwrite -- Agent sieht stale read-back und greift zu workaround). Fix offen: erst Effekt nach FIX-01-07-03 abwarten. Spec: `_devprocess/requirements/fixes/FIX-01-04-01-agent-read-file-instead-of-edit-duplicates.md` |
...
| FIX-01-07-03 | Fix | 07-03: Editor-View-Cache uebermalt vault.modify (restore + edit/write/append) -- Aenderungen werden auf Disk geschrieben, aber CodeMirror-Buffer flusht den Pre-Change-Stand zurueck | Active | Building | FEAT-01-07, EPIC-01, FEAT-01-04, PLAN-38 | BUG | | sebastian-claude-opus-4-7 | 2026-05-23 | P1 Repro-Logs 2026-05-23 bewiesen Hypothese 3 (Editor-Cache), Hypothese 2 widerlegt. Helper `refreshOpenMarkdownViewsFor` (src/core/utils/refreshMarkdownView.ts) per `leaf.openFile(file)` zieht offene MarkdownView vom Disk nach. Konsumenten: GitCheckpointService.restore + EditFileTool (2 Stellen) + WriteFileTool + AppendToFileTool. Diagnose-Logs (read-back + content-snippet) bleiben fuer kuenftige Triage. Spec: `_devprocess/requirements/fixes/FIX-01-07-03-checkpoint-restore-no-effect.md`. Plan: `_devprocess/implementation/plans/PLAN-38-fix-01-07-03-checkpoint-restore-no-effect.md`. Warten auf Sebastians 2026-05-23 Repro-Verifikation -- danach Done. |
