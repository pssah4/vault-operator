...
Vor der Migration wird ein Daily-Snapshot der KnowledgeDB erzwungen, auch wenn der reguliere Snapshot-Zyklus noch nicht faellig ist (das ist eine additive Erweiterung der Snapshot-Mechanik aus FEATURE-0314). Die Lock-File-Mechanik aus FEATURE-0314 verhindert weiterhin parallele Plugin-Instanzen während der Migration. Bei einem Crash mitten in der Migration startet der nächste Plugin-Start die Migration neu, weil sie idempotent ist und die Schema-Versions-Spalte erst nach erfolgreichem Abschluss von v12 auf v13 gesetzt wird.
