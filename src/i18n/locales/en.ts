...
export const en: Translations = {
    ...
    'settings.modes.model': 'Model for this agent',
    'settings.modes.modelDesc': 'Optional override. When empty, the agent uses the model you picked in the chat header.',
    'settings.modes.name': 'Name',
    'settings.modes.slug': 'Slug',
    'settings.modes.useGlobalModel': '\u2014 same as chat \u2014',
    ...
    'settings.modes.availableTools': 'Tools this agent may use',
    'settings.modes.allowedMcpServers': 'Allowed MCP servers',
    'settings.modes.allowedMcpServersHint': 'External tool servers this agent can call. All checked = no restriction.',
