...
export const en: Translations = {
    ...
    'settings.providers.intro': 'Configure one or more LLM providers. The plugin auto-classifies their models into fast / mid / flagship tiers. The active provider drives the chat.',
    ...
    'settings.providers.oauthSignInRedirect': 'OAuth sign-in lives in the Models (legacy) tab during the Welle-2 transition. Sign in there, then return.',
    'settings.providers.discoveredCount': '{count} discovered models',
    'settings.providers.lastRefresh': 'last refresh: {stamp}',
    ...
    'settings.providers.removeConfirm': 'Remove provider "{name}"? This deletes its auth data and tier mapping (model entries stay in legacy_active_models_backup).',
    ...
    'settings.providers.tier.fast': 'Fast',
    'settings.providers.tier.mid': 'Mid',
    'settings.providers.tier.flagship': 'Flagship',
    'settings.providers.tier.autoLabelWith': 'Auto → {id}',
    'settings.providers.tier.autoEmpty': '— auto (no match) —',
