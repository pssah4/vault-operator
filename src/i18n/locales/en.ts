...
export const en: Translations = {
    ...
    'settings.providers.intro': 'Configure one or more LLM providers. The plugin auto-classifies their models into fast, mid, and flagship tiers. The active provider drives the chat.',
    'settings.providers.empty': 'No providers configured yet. Add one below.',
    'settings.providers.activeLabel': 'Active provider',
    'settings.providers.activeDesc': 'This provider drives the chat. Switch between providers per situation (e.g. privacy-sensitive notes on a local model).',
    ...
    'settings.providers.headerDefault': 'Default',
    'settings.providers.remove': 'Remove',
    'settings.providers.enabled': 'Enabled',
    'settings.providers.apiKey': 'API key',
    'settings.providers.apiKeyDesc': 'Credential sent on every request. Stored encrypted via Electron SafeStorage.',
    'settings.providers.baseUrl': 'Base URL',
    'settings.providers.baseUrlDesc': 'Endpoint URL. Required for Ollama, LMStudio, custom OpenAI-compatible gateways, and Azure.',
    'settings.providers.apiVersion': 'API version',
    'settings.providers.apiVersionDesc': 'Azure OpenAI api-version string, e.g. 2024-10-21.',
    'settings.providers.bedrockRegion': 'AWS region',
    'settings.providers.bedrockRegionDesc': 'e.g. eu-central-1, us-east-1.',
    ...
    'settings.providers.oauthStatus': 'OAuth status',
    'settings.providers.oauthAuthed': 'Signed in',
    'settings.providers.oauthNotAuthed': 'Not signed in',
    'settings.providers.oauthSignInRedirect': 'OAuth sign-in still lives in the Models (legacy) tab during the Welle-2 transition. Opening it now.',
    ...
    'settings.providers.addProviderDesc': 'Pick the provider type to add. You can have multiple instances of the same type (e.g. two OpenRouter accounts).',
    'settings.providers.addProvider': 'Add',
    'settings.providers.choosePicker': '— choose a provider type —',
    'settings.providers.duplicateSuffix': 'second instance',
    'settings.providers.tier.fast': 'Fast tier',
    'settings.providers.tier.mid': 'Mid tier',
    'settings.providers.tier.flagship': 'Flagship tier',
    'settings.providers.tier.fastDesc': 'Lowest-latency model. Used by the helper api (condensing, titling) and the research subagent.',
    'settings.providers.tier.midDesc': 'Default main-loop model in Auto mode. Balance between speed and capability.',
    'settings.providers.tier.flagshipDesc': 'Most capable model. Used by consult_flagship for one-shot synthesis steps. Empty = advisor pattern disabled.',
